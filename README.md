...
4. A player puts a damaged whitelisted item into the chest (mining drill, chainsaw, or trimmer).
...
- Gold ingots use the same staffel for every tool (10; below 15% durability -> 15; below 10% -> 20). Other mats are per-tool in `RepairPricing`.
